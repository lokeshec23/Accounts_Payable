                ...
                {!readOnly && (
                    <div style={{ display: 'flex', gap: '10px', justifyContent: 'flex-end' }}>
                        <Button type="primary" icon={<SaveOutlined />} onClick={handleSave}
                            loading={saving} size="default" disabled={disableInputs}>
                            Save
                        </Button>
                        <Button type="primary" icon={<SendOutlined />} onClick={handleSendForCoding}
                            loading={saving} size="default" disabled={disableInputs || isDuplicateError}>
                            Send for Coding
                        </Button>
                    </div>
                )}
