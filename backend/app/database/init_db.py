...
# Load DB Name directly from .env
DB_NAME = os.getenv("DATABASE_NAME", "accounts_payable")
...
def init_database():
    ...
    # Step 1: Ensure the database exists in SQL Server.
    # SQL Server Docker images only ship with 'master'; we must create our DB
    # BEFORE the main engine (which points to it) is first used.
